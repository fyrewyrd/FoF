...
public abstract class Targetable : NetworkBehaviour
{
    ...
    {
        get { return _target != null  ? _target.GetComponent<CharacterSheet>() : null; }
        set { _target = value != null ? value.gameObject : null; }
    }

    [SyncVar] GameObject _caster;
    public CharacterSheet caster
    {
        get { return _caster != null  ? _caster.GetComponent<CharacterSheet>() : null; }
