...
public partial class Player
{
    ...
    // Fixed: use generic SyncList<string>
    public SyncList<string> UCE_exploredAreas = new SyncList<string>();
    ...
    {
        if (UCE_myExploration == null) return;

        if (UCE_myExploration.explorationRequirements.isActive &&
            UCE_myExploration.explorationRequirements.checkRequirements(this))
        {
            // -- explore the area
