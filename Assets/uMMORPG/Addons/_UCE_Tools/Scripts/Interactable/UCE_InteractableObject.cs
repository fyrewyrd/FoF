...
public partial class UCE_InteractableObject : UCE_Interactable
{
    ...
    // -----------------------------------------------------------------------------------
    // Show / Hide / IsHidden - Now handled by DistanceInterestManagement
    // -----------------------------------------------------------------------------------

    [Server]
    public void Show()
    {
        // No longer needed - DistanceInterestManagement on NetworkManager controls visibility
    }
    ...
    {
        // Always return false. We no longer force-hide individual objects.
        // If you need force hidden behavior later, it should be done via the AOI system.
        return false;
    }
