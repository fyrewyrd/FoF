...
public partial class Player : Entity
{
        ...
        get
        {
            ...
            foreach (ItemSlot slot in equipment)
                if (slot.amount > 0)
                    ...
                    equipmentBonus += slot.item.BonusAsPercentageOfEnchantment(((EquipmentItem)slot.item.data).damageBonus, runeType.damage);
        ...
        get
        {
            ...
            foreach (ItemSlot slot in equipment)
                if (slot.amount > 0)
                    ...
                    equipmentBonus += slot.item.BonusAsPercentageOfEnchantment(((EquipmentItem)slot.item.data).damageBonus, runeType.defense);
    ...
    */private EquipmentInfo[] oldEquipmentInfo = {
    ...
    //public Quest quests = new SyncListQuest();
    ...
    public SyncList<int> tradeOfferItems = new SyncList<int>(); // inventory indices - replaced
    ...
    public void OldResetMovement()
    {
        ...
        // commented out for UCE_Sync Entity Positions: agent.ResetMovement();
        ResetMovementAll();
    ...
    // the monster
    [Server]
    public override void DealOldDamageAt(Entity entity, int amount, float stunChance=0, float stunTime=0)
    {
        ...
        // addon system hooks
        Utils.InvokeMany(typeof(Player), this, "DealOldDamageAt_", entity, amount);
    }
