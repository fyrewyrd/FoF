...
public partial class Monster  : Entity {/*
{
    ...
    */public NetworkNavMeshAgent networkNavMeshAgent { get { return my.networkNavMeshAgent; } set { my.networkNavMeshAgent = value; } }/*
    ...
    [Header("Movement")]
    [Range(0, 1)] */public float moveProbability { get { return my.ai.moveProbability; } } // chance per second
    ...
    [Range(0.1f, 1)] */public float attackToMoveRangeRatio { get { return my.ai.optimalRange; } } // move as close as 0.8 * attackRange to a target
    ...
    {
        // commented out for UCE_Sync Entity position: agent.ResetMovement();
        ResetMovementAll();
    }
    ...
    [Server]
    protected string OldUpdateServer()
    {
    ...
    [Client]
    protected void OldUpdateClient()
    {
        if (state == "CASTING")
        {
            // keep looking at the target for server & clients (only Y rotation)
    ...
    [ServerCallback]
    public void OldOnAggro(Entity entity)
    {
